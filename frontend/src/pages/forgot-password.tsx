...
const ForgotPassword: React.FC<{}> = ({ }) => {
    ...
    // Only if content is loaded, it will display the component
    // This is to avoid an error that is occurring in React 18
                    ...
                    <Stack spacing="8">
                        ...
                        >
                            <Formik initialValues={{ email: "" }} onSubmit={async (values) => {
                                ...
                                {/* If the request is complete, display a message saying that the email has been sent */}
