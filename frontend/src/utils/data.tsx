    ...
    special: () => (
      <>
        <h2>
          <AccordionButton>
            <Box as="span" flex="1" textAlign="left">
              <Heading fontSize={"xl"}>How do I log into the website?</Heading>
            </Box>
            <AccordionIcon />
          </AccordionButton>
        </h2>
        <AccordionPanel pb={4} alignItems={"ceter"}>
          ...
          <Text mt={8}>1. Navigate to the home page by clicking home</Text>
          <Box mt={4}>
            <Image
              src={"/loginsteps/LoginStep1.png"}
              alt="Press login button on homepage"
              width={900}
              height={100}
            />
          </Box>
          <Divider />
          <Text mt={8}>2. Click login to access the login page</Text>
          <Box mt={4}>
            <Image
              src={"/loginsteps/LoginStep2.png"}
              alt="Press login button on homepage"
              width={900}
              height={100}
            />
          ...
          <Divider />
          <Text mt={8}>
            3. Enter your username and password. You can also use your email if
            you do not remember your username Make sure that the length of both
            are at least 3 characters, and the username does not include an
            at-sign
          </Text>
          <Flex>
            <Box m="auto" mt={4}>
              <Image
                src={"/loginsteps/LoginStep3.png"}
                alt="Press login button on homepage"
                width={400}
                height={400}
              />
    ...
    special: () => (
      <>
        ...
        <AccordionPanel pb={4} alignItems={"center"}>
          ...
          <Box mt={4}>
            <Image
              src={"/registersteps/RegisterStep1.png"}
              alt="Press login button on homepage"
              width={900}
              height={100}
            />
          ...
          <Box mt={4}>
            <Image
              src={"/registersteps/RegisterStep2.png"}
              alt="Press login button on homepage"
              width={900}
              height={100}
            />
          ...
          <Divider />
          <Text mt={8}>
            3. Enter your username, email and password. Make sure that the
            length of all fields is at least 3 characters, the username does not
            include an at sign, your email must have an at sign, and both of
            your passwords are the same
          </Text>
          <Flex>
            <Box m="auto" mt={4}>
              <Image
                src={"/registersteps/RegisterStep3.png"}
                alt="Press login button on homepage"
                width={400}
                height={400}
              />
          ...
          <Flex>
            <Box m="auto" mt={4}>
              <Image
                src={"/registersteps/RegisterStep4.png"}
                alt="Press login button on homepage"
                width={400}
                height={400}
              />
  ...
  },
  {
    special: () => (
      <>
        ...
        <AccordionPanel pb={4} alignItems={"ceter"}>
          <Text size={"md"}>How to add an organization</Text>
          <Text mt={8}>
            1. Navigate to the main app page and make sure you are logged in
          </Text>

          <Divider />
          <Text mt={8}>2. Click on the Add Organization button</Text>
          <Divider />
          <Text mt={8}>
...
export const features: FeatureData[] = [
  {
    ...
    detail:
      "This website is completely free, and available on GitHub, with absolutely not paid plans or ads, and without tracking",
  },
  {
    title: "Secure",
    detail:
      "With SchoolDB, your data will always be safe, with the latest encryption techniques on your accounts to make sure your account never gets compromised",
  },
  {
    title: "Easy to Use",
    detail:
      "The Website is easy to use, even for novice users, with every function being clearly labeled",
  },
];
...
export const reviewData: ReviewData[] = [
  {
    ...
    content:
      "PeelDB helped my school immensely with other wonderful businesses that the community offers. With SchoolDB, I helped increase of clubs by 200%, and increased engagement by 60%",
  ...
  },
  {
    name: "Edward Lin",
    content:
      "PeelDB helped my class learn about where we get our resources and encouraged them to donate to the non-profits that they want to support",
  ...
  },
  {
    name: "Manat Manat",
    content:
      "PeelDB helped me find great non-profit organizations I can volunteer at and get more hours for work experience!",
    position: "Student at EL Schools",
  },
  {
    name: "Manav Vasa",
    content:
      "PeelDB helped our school find more information about the organizations we are involved in and organizations our teachers have found",
    position: "Principals at MV Schools located in Brampton",
  },
  {
    name: "Pradyuman Uppal",
    content:
      "PeelDB helped me get numerous jobs for organizations close to the school, which helped me advance my portfolio for university",
